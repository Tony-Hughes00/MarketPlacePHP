...
// var_dump($data);
  ...
  <form method="post" action="exportChauffeurs" id="formExport"> 
  <div class="row">
    <div class="col-12">
...
?>
    ...
    <a 
    onclick="submitForm('exportChauffeurs.prev')">
    ...
    <div class="col-1 text-center" >
    <a 
    onclick="submitForm('exportChauffeurs.next')">
    ...
    <div class="col-12 exportBox">
      ...
      <div class="col-12 text-center">
        ...
        <fieldset class="form-card">
          ...
          <input type="radio" id="exportTypeTous" name="pnmSelect" value="tous" 
        ...
        <label for="exportTypePnm">par pnm</label>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              ...
              onclick="refreshForm('exportChauffeurs.noChange');"
              <?php
          ...
          <div class="col-12">
            <input type="submit" for="exportChauffeurs" 
...
<script type="text/javascript">
  ...
  function onClickRadioPeriode(ctrl) {
    ...
    refreshForm("exportChauffeurs.noChange");
