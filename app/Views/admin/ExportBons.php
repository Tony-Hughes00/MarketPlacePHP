...
// var_dump($data);
  ...
  <form method="post" action="exportBons" id="formExport"> 
<div class="container">
  <div class="row">
    <div class="col-12">
...
?>
    ...
    <a 
    onclick="submitForm('exportBons.prev')">
    ...
    <div class="col-1 text-center" >
    <a 
    onclick="submitForm('exportBons.next')">
...
<script type="text/javascript">
  ...
  function onClickRadioPeriode(ctrl) {
    ...
    refreshForm("exportBons.noChange");
