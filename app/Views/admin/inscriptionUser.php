    ...
    <div class="row justify-content-center mt-0">
        <div class="col-11 col-sm-9 col-md-11 col-lg-7 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <div class="row">
                    <div class="col">
                        <h2 class="text-center">Formulaire d'inscription
                             <? //= (isset($userType) && $userType === 'chauffeur') ? 'Chauffeur Bénévole' : 'Passager'; ?>
                             <?php if(isset($userType) && $userType === 'chauffeur') {echo 'Chauffeur Bénévole';}
                              if(isset($userType) && $userType === 'passager') {echo 'Passager';}
                              if(!isset($userType)){ echo'';} ?>
                            </h2>
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form method="post" action="<?=ROUTE?>ficheUser" id="form-ins">
                                ...
                                <div id="step-1" class="step tab-pane" role="tabpanel" aria-labelledby="step-1">
                                    <fieldset>
                                        <div class="form-card p-3 p-md-5">
                                            ...
                                            <!-- TYPE -->
                                            <div class="row">
                                                <span class="col-sm-2 col-md-3 col-lg-2">Type : </span>
                                                <div class="form-row col-sm-10 col-md-9 col-lg-10 mb-4">
                                                    <div class="col-md-12">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" id="ins_type_1" name="ins_type"
                                                                value="chauffeur" class="custom-control-input" required 
                                                                <?= (isset($userType) && $userType === 'chauffeur') ? 'checked' : ''; ?>
                                                                >
                                                            <label class="radio-label custom-control-label"
                                                                for="ins_type_1">Chauffeur Bénévole</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" id="ins_type_2" name="ins_type"
                                                                value="passager" class="custom-control-input" required 
                                                                <?= (isset($userType) && $userType === 'passager') ? 'checked' : ''; ?>
                                                                >
                                                            <label class="radio-label custom-control-label"
                                                                for="ins_type_2">Passager</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
