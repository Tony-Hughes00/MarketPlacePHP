...
class Carte {
    ...
    private function openSVG() {
        echo '<svg width="500px" id="svgDiv" version="1.1" xmlns:bx="https://boxy-svg.com" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" 
        viewPort="0px 0px 100px 100px"
        viewBox="0 0 900 700"  xml:space="preserve">';
    }
    ...
    public function onLoad() {
        echo "<script>";
        echo "onLoadFichePnm(" . json_encode($this->data) . ")";
        echo "</script>";
    }
