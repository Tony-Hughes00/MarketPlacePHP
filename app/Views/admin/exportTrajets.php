...
// var_dump($data);
  ...
  if ($data['periodeRadio'] == 'annee') {
    ...
    if ($data['periodeRadio'] == 'semaine') {
      $JSON = getTrajetByDayOfWeek($data, $data['periodeDebut'], $data['periodeFin']);
      $legend = 'semaine' . ' - ' . $periodeDebut->format("d/m/Y") . ' à ' .$periodeFin->format("d/m/Y");
    } else {
      $JSON = getTrajetByDay($data);
  ...
  <form method="post" action="exportTrajets" id="formExport"> 
<div class="container">
  <div class="row">
    <div class="col-12">
        ...
        <label for="exportTypePnm">par pnm</label>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              ...
              onclick="refreshForm('exportTrajets.noChange');"
              <?php
...
<script type="text/javascript">
  ...
  function onClickRadioPeriode(ctrl) {
    ...
    refreshForm("exportTrajets.noChange");
  }
