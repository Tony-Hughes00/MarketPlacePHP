...
// var_dump($data);
  ...
  <form method="post" action="exportCotis" id="formExport"> 
<div class="container">
  <div class="row">
    <div class="col-12">
...
?>
    ...
    <a 
    onclick="submitForm('exportCotis.prev')">
    ...
    <div class="col-1 text-center" >
    <a 
    onclick="submitForm('exportCotis.next')">
...
<script type="text/javascript">
  ...
  function onClickRadioPeriode(ctrl) {
    ...
    refreshForm("exportCotis.noChange");
