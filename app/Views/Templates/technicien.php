...
<body>
    ...
    <div class="container-fluid blur-switch unblur">
        ...
        <div class="container-fluid blur-switch unblur">
            ...
            <?php
            // Barre de navigation
            if (isset($_SESSION['transport-solidaire']['statut']) && ($_SESSION['transport-solidaire']['statut'] == 'conseiller' )) {
                include_once 'nav-conseiller.php';
            } else if (isset($_SESSION['transport-solidaire']['statut']) && ($_SESSION['transport-solidaire']['statut'] == 'admin' )) {
...
?>
            ...
            <div class="row align-items-center justify-content-md-center mb-5">
                <div class="footer-pnm-main col-md-4 text-center mb-5 mb-md-0">
                    <div class="footer-pnm-a-cont">
                        <b><a href="https://mosc.fr/" target="_blank" style="text-decoration:none; color:black;">
                                <img src="<?= RACINE ?>images/logo-mosc.png" alt="Logo MOSC" style="max-width:250px;"
                                    class="contact-logo img-fluid mb-3">
                                <br>
                                Siège Social
                            </a>
                    </div>
                ...
                <div class="contact-mosc col-md-6 text-center">
                    <a class="num-ref text-primary border border-primary border-4 p-4 d-block" href="tel:+33782327633">
